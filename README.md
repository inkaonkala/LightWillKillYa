...
Welcome to play "Light will kill ya". The game should tell you what to do, but here it is one more time.

Pass the levels by not touching the light. This means the player should stay on the blackness all the time.

Jump by pressing space.

Toggle the enemy light by pressing ctrl.

Run through 4 levels and descent to darkness!
